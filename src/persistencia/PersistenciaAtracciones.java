...
/**
 * Clase para la persistencia de atracciones y espectáculos
 */
public class PersistenciaAtracciones {
    ...
    /**
     * Guarda una lista de atracciones mecánicas
     * 
     * @param atraccionesMecanicas La lista a guardar
     * @throws AtraccionException Si hay un error al guardar las atracciones
     */
    public void guardarAtraccionesMecanicas(List<AtraccionMecanica> atraccionesMecanicas) throws AtraccionException {
        try {
            ...
            for (AtraccionMecanica atraccion : atraccionesMecanicas) {
                // Construir una línea con los datos de la atracción separados por |
            ...
            ArchivoUtil.guardarLineas(lineas, ARCHIVO_ATRACCIONES_MECANICAS);
    ...
    /**
     * Guarda una lista de atracciones culturales
     * 
     * @param atraccionesCulturales La lista a guardar
     * @throws AtraccionException Si hay un error al guardar las atracciones
     */
    public void guardarAtraccionesCulturales(List<AtraccionCultural> atraccionesCulturales) throws AtraccionException {
        try {
            ...
            ArchivoUtil.guardarLineas(lineas, ARCHIVO_ATRACCIONES_CULTURALES);
    ...
    /**
     * Guarda una lista de espectáculos
     * 
     * @param espectaculos La lista a guardar
     * @throws AtraccionException Si hay un error al guardar los espectáculos
     */
    public void guardarEspectaculos(List<Espectaculo> espectaculos) throws AtraccionException {
        try {
            ...
            for (Espectaculo espectaculo : espectaculos) {
                // Construir una línea con los datos del espectáculo separados por |
                StringBuilder sb = new StringBuilder();
                ...
                // Guardar las funciones del espectáculo
            ...
            ArchivoUtil.guardarLineas(lineas, ARCHIVO_ESPECTACULOS);
    ...
    /**
     * Carga la lista de atracciones mecánicas
     * 
     * @return La lista de atracciones mecánicas
     * @throws AtraccionException Si hay un error al cargar las atracciones
     */
    public List<AtraccionMecanica> cargarAtraccionesMecanicas() throws AtraccionException {
        ...
        try {
            if (ArchivoUtil.existeArchivo(ARCHIVO_ATRACCIONES_MECANICAS)) {
                List<String> lineas = ArchivoUtil.cargarLineas(ARCHIVO_ATRACCIONES_MECANICAS);
    ...
    /**
     * Carga la lista de atracciones culturales
     * 
     * @return La lista de atracciones culturales
     * @throws AtraccionException Si hay un error al cargar las atracciones
     */
    public List<AtraccionCultural> cargarAtraccionesCulturales() throws AtraccionException {
        ...
        try {
            if (ArchivoUtil.existeArchivo(ARCHIVO_ATRACCIONES_CULTURALES)) {
                List<String> lineas = ArchivoUtil.cargarLineas(ARCHIVO_ATRACCIONES_CULTURALES);
    ...
    /**
     * Carga la lista de espectáculos
     * 
     * @return La lista de espectáculos
     * @throws AtraccionException Si hay un error al cargar los espectáculos
     */
    public List<Espectaculo> cargarEspectaculos() throws AtraccionException {
        List<Espectaculo> espectaculos = new ArrayList<>();
        
        try {
            if (ArchivoUtil.existeArchivo(ARCHIVO_ESPECTACULOS)) {
                List<String> lineas = ArchivoUtil.cargarLineas(ARCHIVO_ESPECTACULOS);
                ...
                for (String linea : lineas) {
                    ...
                    if (partes.length >= 9) {
                        ...
                        // Cargar las funciones del espectáculo
    ...
    /**
     * Carga todas las atracciones (mecánicas y culturales)
     * 
